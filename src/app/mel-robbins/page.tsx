...
const format = [
  ...
  ["CTA", "'Comment [WORD] and I'll DM you the link.' Every single podcast clip."],
];
...
export default function Page() {
  return (
    <div className="max-w-5xl mx-auto px-6 pt-12 pb-20">
      ...
      <p className="text-muted-foreground text-sm mb-6">Watch for: expert guest, health hook, keyword CTA.</p>
      ...
      <div className="space-y-10">
        ...
        <div>
          ...
          <Embed url="https://www.instagram.com/reel/DX3O5g7jKVm/" note="80.8K likes — permission + keyword CTA = high engagement" />
        </div>
        <div>
